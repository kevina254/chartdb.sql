...
INSERT INTO Car1 (CarModel, Manufacturer, Year, Color, RentalRate, Availability) 
VALUES
...
UPDATE Car1 SET Availability = 0 WHERE CarID = 1;

-- Increase rental rate for Toyota cars
UPDATE Car1 SET RentalRate = RentalRate * 1.1 WHERE Manufacturer = 'Toyota';
SELECT * FROM Car1;
